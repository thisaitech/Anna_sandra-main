...
const steps = [
  ...
  'node tools/patch-fix-empty-lists.cjs',
  'node tools/patch-fix-sales-persist.cjs',
  'node tools/patch-invoices-like-parties.cjs',
  'node tools/patch-fix-permissions-and-sales.cjs',
  'node tools/patch-pos-payment-total.cjs',
  'node tools/patch-sync-handlers-bootstrap.cjs',
  'node tools/fix-sync-reg-syntax.cjs',
  'node tools/patch-sync-fix-desktop.cjs',
  'node tools/patch-sync-clear-error.cjs',
  'node tools/patch-sync-error-ux.cjs',
  'node tools/patch-offline-auth.cjs',
  'node tools/patch-desktop-ui.cjs',
